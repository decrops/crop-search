...
CREATE TABLE IF NOT EXISTS normalized_claims (
  ...
  location_geo_id TEXT,
  location_centroid_lat DOUBLE PRECISION,
  location_centroid_lon DOUBLE PRECISION,
  location_bbox_json JSONB,
  source_location_level TEXT NOT NULL,
  ...
  source_geo_scope_json JSONB NOT NULL,
  geo_evidence_json JSONB NOT NULL,
